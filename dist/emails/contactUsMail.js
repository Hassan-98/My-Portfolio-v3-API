...
exports.emailTemplateCreator = void 0;
const dayjs_1 = __importDefault(require("dayjs"));
const emailTemplateCreator = ({ fullName, email, message, date }) => `
              ...
              <tr>
                <td style="color:#153643;">
                  ...
                  <p style="margin: 15px 0 0;font-size:16px;line-height:24px;font-family:'Google Sans', 'sans-serif';">
                    ...
                    <p style="margin:10px 5px 0;font-size:16px;font-family:'Google Sans','sans-serif';">${(0, dayjs_1.default)(date).format('DD/MM/YYYY  |  hh:mm a')}</p>
                  </p>
                </td>
              </tr>
            </table>
...
//# sourceMappingURL=contactUsMail.js.map